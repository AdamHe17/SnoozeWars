...
public class MainActivity extends AppCompatActivity {
    ...
    public void checkAlarm() {
        ...
        Log.d("main","MAIN");
        Log.d("calhour",Integer.toString(c.get(Calendar.HOUR_OF_DAY))+"=="+Integer.toString(A.hour));
        Log.d("calmin", Integer.toString(c.get(Calendar.MINUTE)) + "==" + Integer.toString(A.min));
